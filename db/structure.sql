...
--
-- Name: admin_logs; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
CREATE TABLE hot_topics (
    ...
    random_bias double precision,
    random_multiplier double precision,
    days_ago_bias double precision,
    days_ago_multiplier double precision,
    hot_topic_type integer
);


--
-- Name: hot_topics_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE hot_topics_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: hot_topics_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE hot_topics_id_seq OWNED BY hot_topics.id;
...
--
-- Name: site_contents; Type: TABLE; Schema: public; Owner: -; Tablespace: 
--
...
ALTER TABLE ONLY admin_logs ALTER COLUMN id SET DEFAULT nextval('admin_logs_id_seq'::regclass);
...
ALTER TABLE ONLY hot_topics ALTER COLUMN id SET DEFAULT nextval('hot_topics_id_seq'::regclass);
...
--
-- Name: admin_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: -; Tablespace: 
--

ALTER TABLE ONLY admin_logs
...
CREATE INDEX index_hot_topics_on_score ON hot_topics USING btree (score DESC);


--
-- Name: index_hot_topics_on_topic_id; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--

CREATE UNIQUE INDEX index_hot_topics_on_topic_id ON hot_topics USING btree (topic_id);
...
--
-- Name: index_site_contents_on_content_type; Type: INDEX; Schema: public; Owner: -; Tablespace: 
--
